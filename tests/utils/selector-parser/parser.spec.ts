import { EnumComparator } from "../../../src/enums/enum-comparator";
import { EnumFileTypeFilter } from "../../../src/enums/enum-file-type-filter";
import { filter } from "../../../src/utils/selector-parser/filter";
import { parseDurationParam, parseExtensionsParam, parseFileTypeParam } from "../../../src/utils/selector-parser/parse";
import { compare } from "../../../src/utils/selector-parser/utils";

describe('parseFileTypeParam', () => {
    test(`Valid input tests`, () => {
        expect(parseFileTypeParam('all')!.data).toBe('all');
        expect(parseFileTypeParam('videos')!.data
